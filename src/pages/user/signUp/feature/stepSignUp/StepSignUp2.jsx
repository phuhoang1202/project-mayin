...
import ContentPrivacyPolicy from '@pages/user/policy/documentContent/ContentPrivacyPolicy'
import ContentTermsOfUse from '@pages/user/policy/documentContent/ContentTermsOfUse'
