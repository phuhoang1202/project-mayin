    ...
    try {
      if (id) {
        ...
        setDataInput((prevData) => ({
          ...
          emailConfirmPayment: productData.emailConfirmPayment ? productData.emailConfirmPayment.split(',') : [],
        ...
        setValueAttribule(productData.productSkus.length > 1 ? 2 : 1)
          ...
          {dataInput?.productName ? (
            <Form
              initialValues={{
                ...
                stockQuantity,
                platformType,
                email: emailConfirmPayment?.map((email) => ({ email })),
              }}
            >
                ...
                <div className='flex flex-col gap-1 flex-1'>
                  ...
                  >
                    <Input
                      ...
                      className='border px-2 rounded-lg min-h-11'
                      value={productName}
                      name='productName'
