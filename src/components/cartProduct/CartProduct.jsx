                      ...
                      <div className='flex rounded-lg gap-5 relative'>
                        <div className='flex gap-4'>
                          ...
                          <img
                            src={imageUrl}
                            alt='photo'
                            className='lg:w-[184px] lg:h-[132px] w-[100px] h-[132px]  object-cover rounded-lg'
                          />
                        </div>
                        <div>
                          <div className='flex flex-col justify-between gap-2 py-1 lg:w-[531px] w-full h-full'>
                            <div className='flex flex-col gap-4'>
                              <h3 className='font-semibold lg:text-primaryPrdName truncate lg:w-full w-[200px]'>
                                <Tooltip title={store.product.productName}>{store.product.productName}</Tooltip>
                              </h3>
                              <div className='text-normal font-medium flex items-center gap-2'>
                                ...
                                store.product.promotions.some((e) => e.type === 'sale') ? (
                                  ...
                                  <div className='flex items-center gap-1'>
                                    <div className='font-semibold lg:text-primaryPrdName text-[#3B3B3B]'>
                                      {formatPrice(store.product.price)}
                                    </div>
                                    <div className='font-semibold lg:text-small text-small text-[#707070]'>
                                      {unit !== 'KRW'
                                        ? '/' +
                                          ' ' +
                          ...
                          <div key={attrIndex} className='mt-2 px-2 relative'>
                            <div className='pb-4 flex p-4 gap-5' style={{ borderBottom: '1px solid #EFEFEF' }}>
                              ...
                              <div className='w-full'>
                                <div
                                  className='w-80 font-medium text-normal flex relative'
                                ...
                                >
                                  <div className='truncate'>
                                    ...
                                    {productAttribute.productSku.attributes.map((attributes, attrIndex) => (
                                      <span key={attrIndex}>
                                        {multilingualProperties(attributes.type, language) +
                                          ': ' +
                                ...
                                <div className='flex justify-between items-center w-full mt-2'>
                                  ...
                                  <div className='flex flex-col gap-[2px]'>
                                    <div className='font-bold text-normal text-[#3B3B3B]'>
                                      {formatPrice(productAttribute.productSku.price)}/ {t('piece')}
                                    </div>
                                  ...
                                  <div className='flex items-center lg:gap-8 gap-2'>
                                    <div className='flex justify-between items-center lg:w-[132px] h-8 border p-1 rounded-lg'>
                                      <button
                                      ...
                                      <input
                                        inputMode='numeric'
                                        className='font-semibold text-xl lg:w-16 w-14 text-center'
                                    ...
                                    <div className='flex flex-col items-end min-w-20 gap-1'>
