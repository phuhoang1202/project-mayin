...
const items = [
  {
    key: '1',
    label: <div className='font-semibold lg:text-primaryPrdName text-[#3B3B3B]'>카테고리명A</div>,
    children: renderTabContent(),
  },
  {
    key: '2',
    label: <div className='font-semibold lg:text-primaryPrdName text-[#3B3B3B]'>카테고리명B</div>,
    children: renderTabContent(),
  },
  {
    key: '3',
    label: <div className='font-semibold lg:text-primaryPrdName text-[#3B3B3B]'>카테고리명C</div>,
    children: renderTabContent(),
  },
]
...
export default function Service() {
  return (
    <div className='lg:max-w-7xl w-full mx-auto lg:mt-24 mt-28 text-[#3B3B3B] lg:px-0 px-5'>
