            ...
            <>
              ...
              <div className='lg:max-w-7xl mx-auto mt-10'>
                <div className='flex lg:gap-10 gap-4 flex-col lg:flex-row justify-between'>
                  ...
                  <div className='lg:w-[481px] w-full mx-auto px-4 flex flex-col gap-4'>
                    ...
                    <div className='flex items-center gap-4'>
                      {shippingFee === 0 && (
                        <div className='w-fit'>
                          <div className='flex items-center gap-1 bg-[#EFEFEF] h-8 px-4 flex-shrink-0 rounded-md'>
                    ...
                    <div>
                      <div>
                        {/* Option 1 */}
                        {Array.isArray(dataDetail?.productAttributeModels) &&
                        dataDetail.productAttributeModels.length > 0 ? (
                          <div className='mt-2'>
                          ...
                          <div>
                            <div>
                              ...
                              <div className='flex flex-col gap-2 mt-4 border-t pt-4'>
                                ...
                                <div className='flex justify-between items-center font-medium lg:text-textPrd'>
                                ...
                                <div className='flex justify-between items-center font-bold lg:text-[32px] text-largerPrdName'>
                                  <div>{t('totalBill')}</div>
                                  <div>
