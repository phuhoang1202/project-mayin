  ...
  const items = [
    {
      ...
      label: (
        <div
          className={`font-semibold lg:text-primaryPrdName ${activeKey === '1' ? 'text-[#3B3B3B]' : 'text-[#8C8C8C]'}`}
        >
          {t('titleFAQ1')}
        </div>
      ),
            ...
            <div key={item.key} className='mb-4 w-full'>
              <Collapse
                ...
                items={[
                  {
                    key: item.key,
                    label: <div className='font-bold lg:text-primaryPrdName'>{item.label}</div>,
                    children: (
    ...
    },
    {
      ...
      label: (
        <div
          className={`font-semibold lg:text-primaryPrdName ${activeKey === '2' ? 'text-[#3B3B3B]' : 'text-[#8C8C8C]'}`}
        >
          {t('titleFAQ2')}
        </div>
      ),
    ...
    },
    {
      ...
      label: (
        <div
          className={`font-semibold lg:text-primaryPrdName ${activeKey === '3' ? 'text-[#3B3B3B]' : 'text-[#8C8C8C]'}`}
        >
          {t('titleFAQ3')}
        </div>
      ),
