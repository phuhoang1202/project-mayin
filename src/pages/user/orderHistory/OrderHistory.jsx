...
export default function OrderHistory() {
  ...
  }, [statusOrder, currentPage, fromDate])
  ...
  const orderStatuses = [
    ...
    { key: 'COMPLETED', label: t('successOrder') },
            ...
            dataOrder.map((order, index) => {
              ...
              return (
                <div className='mt-6' key={index}>
                  <div className='bg-[#F8F8F8] flex lg:flex-row flex-col items-center justify-between lg:min-h-[199px] p-4 lg:gap-8 gap-2 rounded-t-lg'>
                    <div className='flex items-start lg:gap-6 gap-2 flex-1'>
                      <div className='lg:w-40 h-40 w-32'>
                        <img
                          src={imageUrl}
                          alt='image'
                      ...
                      <div className='flex flex-col gap-[10px] px-[10px] lg:w-[350px]'>
                        <div>
                          <h3 className='text-#3B3B3B font-semibold lg:text-primaryPrdName'>
                            <Tooltip title={order?.orderItems[0]?.product.productName}>
                              <div>
                                {order?.orderItems[0]?.product.productName}
                                {/* {order?.orderItems[0]?.product.productName.length > 40
                                  ? `${order?.orderItems[0]?.product.productName.substring(0, 30)}...`
                                  : order?.orderItems[0]?.product.productName} */}
                              </div>
                            </Tooltip>
                            {/* {order?.orderItems[0]?.product.productName} */}
                          </h3>
                          <div className='text-normal font-semibold mt-1'>
                                      ...
                                      return (
                                        <div key={index}>
                                          {attribute.productSku.attributes.map((sku, index) => {
                                            return (
                                              <div key={index}>
                                                {multilingualProperties(sku.type, language)}: {sku.attributeName}
                                              </div>
                                            )
                                          })}
                                        </div>
                    ...
                    <div className=' flex flex-col items-end justify-between lg:gap-8 gap-4 flex-1'>
                      <div
                      ...
                      <div className='flex flex-col gap-2 items-end'>
                        ...
                        <div className='flex flex-col  items-end gap-1 text-small'>
                          ...
                          <div className='bg-[#EFEFEF] px-2 py-1 h-[22px] flex justify-center items-center'>
                            {t('copyText')}
                          </div>
                        </div>
