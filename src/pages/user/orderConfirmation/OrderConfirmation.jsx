...
export default function OrderConfirmation() {
  ...
  return (
    <div className='max-w-7xl mx-auto mt-28 lg:px-0 px-2'>
      <ScrollToTop />
      {/* Steps container */}
      <div className='flex items-center  w-full'>
        {stepsCurrent.map((step, index) => (
          <div key={index} className='flex items-center lg:gap-1 gap-0 '>
            {/* Step circle */}
            <div
              className={`flex items-center justify-center lg:w-10 lg:h-10 w-9 h-9 rounded-md font-bold lg:text-textPrd ${
            ...
            <div className='lg:ml-2 ml-1'>
              <div
                ...
                } font-semibold lg:text-normal text-small `}
              >
                {step.step}
              </div>
            ...
            {/* Step connector line */}
            {index < stepsCurrent.length - 1 && (
              <img src={IconArrowRight} alt='icon' className='lg:mx-2 mx-0 w-4 h-4' />
            )}
          </div>
        ))}
      </div>
